---
layout: post
title:  Code review of crossbar.io
...
In short, crossbar.io aims to provide an end-to-end framework which takes advantages of websockets to implement [WAMP](http://wamp.ws/), allowing you to handle/trigger events without polling. 
...
Fantastic idea let down by poor architectural design, bad code quality, excessive [SLOC](http://en.wikipedia.org/wiki/Source_lines_of_code) and unclear documentation. Personally I would choose not to use this in production or for any personal projects.
